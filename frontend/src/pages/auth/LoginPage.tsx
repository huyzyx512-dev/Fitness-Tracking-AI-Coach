  ...
  return (
    <div className="animate-fade-up">
      <div className="mb-8 text-center">
        ...
        <p className="text-sm text-muted mt-1">Đăng nhập để tiếp tục luyện tập</p>
      </div>
      ...
      <p className="text-sm text-center text-muted mt-6">
        Chưa có tài khoản?{' '}
        <Link to={ROUTES.REGISTER} className="text-accent hover:text-accent-light font-medium transition-colors">
          Đăng ký ngay
        </Link>
      </p>
    </div>
